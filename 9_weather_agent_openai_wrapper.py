...
response=client.chat.completions.create(
    ...
    messages=[
        ...
        {'role':'assistant','content':json.dumps({"step": "plan", "content": "The user is interested in the weather data of New York."})},
        ...
        {'role':'assistant','content':json.dumps({"step": "observe", "output": "15 degree celsius, clear sky"})}
    ],
...
#     model="gemini-2.5-flash", contents="What is the weather of NewYork?",
